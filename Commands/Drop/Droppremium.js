...
const cooldowns = new Map(); // Initialize cooldowns as a Map

module.exports = {
    data: new SlashCommandBuilder()
        .setName('drop_premium')
    ...
    async execute(interaction) {
        ...
        if (cooldowns.has(userId)) {
            ...
            if (now - lastUsed < cooldownTime) {
                ...
                return interaction.reply(`Musisz poczekać ${remainingTime} godzin przed ponownym użyciem tej komendy.`);
            }
        }
